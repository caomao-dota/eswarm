...
You must have your working copy under `$GOPATH/src/github.com/plotozhu/MDCMainnet`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/plotozhu/MDCMainnet
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/plotozhu/MDCMainnet/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/plotozhu/MDCMainnet/wiki/Code-Review-Guidelines).
