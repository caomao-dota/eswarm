...
//
// # go test -benchmem -run=none github.com/plotozhu/MDCMainnet/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
...
//
// go test -benchmem -run=none github.com/plotozhu/MDCMainnet/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: github.com/plotozhu/MDCMainnet/swarm/storage/localstore
