...
const (
	defaultLDBCapacity                = 50000000 // capacity for LevelDB, by default 5*10^6*4096 bytes == 20GB
	defaultCacheCapacity              = 10000   // capacity for in-memory chunks' cache
	defaultChunkRequestsCacheCapacity = 50000000 // capacity for container holding outgoing requests for chunks. should be set to LevelDB capacity
)
