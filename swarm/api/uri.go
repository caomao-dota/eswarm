...
func Parse(rawuri string) (*URI, error) {
	...
	switch uri.Scheme {
	case "bzz", "bzz-raw", "bzz-immutable", "bzz-list", "bzz-hash", "bzz-feed", "chunk", "metrics", "m3u8", "activate", "receipts", "duration", "nodes":
	default:
...
func (u *URI) M3u8() bool {
	return u.Scheme == "m3u8"
}
func (u *URI) Activate() bool {
	return u.Scheme == "m3u8"
}
